...
function CommunityServices(Service, Characteristic) {
    // Services
    ...
    this.AtmosphericPressureSensor = function(displayName, subtype) {
        Service.call(this, displayName, 'B77831FD-D66A-46A4-B66D-FD7EE8DFE3CE', subtype);
    ...
    this.NoiseLevelSensor = function(displayName, subtype) {
        Service.call(this, displayName, '28FDA6BC-9C2A-4DEA-AAFD-B49DB6D155AB', subtype);
    ...
    this.AirFlowSensor = function(displayName, subtype) {
        Service.call(this, displayName, 'AF5C192E-420F-4A13-AB67-B8F3968A4935', subtype);
    ...
    this.NitrogenDioxideSensor = function(displayName, subtype) {
        Service.call(this, displayName, '9F6B797D-D43B-4C88-9AA0-57018AB8A91E', subtype);
    ...
    this.OzoneSensor = function(displayName, subtype) {
        Service.call(this, displayName, 'B91C2BD6-D071-4F49-A23B-20721AC6CCEB', subtype);
    ...
    this.SodiumDioxideSensor = function(displayName, subtype) {
        Service.call(this, displayName, 'FE7CFB1F-12D0-405D-86FD-7E268D65C453', subtype);
    ...
    this.VolatileOrganicCompoundSensor = function(displayName, subtype) {
        Service.call(this, displayName, '776E34BC-1660-46EC-A33D-2DFE5B958699', subtype);
...
module.exports.CommunityServices = CommunityServices;